  ...
  return (
    <>
      ...
      <div className="relative bg-[#0F0E0D]">
        <div className=" flex flex-col  md:flex-row items-center md:py-0 py-5">
          <div className="">
            <img src={gradient2} className="w-full" alt="" />
          </div>
          <div className=" absolute inset-0 flex  text-white items-center md:px-20 px-5 ">
            <div>
            ...
            <div className="text-[grey] md:px-20 px-5 ">
              <p>
      ...
      <div className="bg-[#161518]">
        <div className="flex  flex-col md:flex-row md:px-20 px-5 md:py-[100px] py-10 md:gap-0 gap-">
          <div className="">
